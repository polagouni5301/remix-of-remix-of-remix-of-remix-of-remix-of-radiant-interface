          ...
          <div className="relative flex items-start gap-6">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-4 max-w-2xl text-[16px] leading-[1.6] text-muted-foreground">
                These are commitments to look, not predictions of outcomes. If a check comes back
                differently than I'd expect, I'll surface it back here with what's different.
              </p>
            </div>
          </div>
        </motion.section>
              ...
              {OBSERVATIONS.map((item) => (
                ...
                >
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-6">
                    ...
                    <p className="text-[15px] leading-[1.55] text-foreground">{item.text}</p>
                  </div>
                </div>
              ))}
            </div>
