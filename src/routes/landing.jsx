    ...
    <div className="relative mx-auto w-full max-w-[740px] lg:max-w-[740px]">
      ...
      <div className="relative overflow-hidden rounded-[1.8rem] border border-white/10 bg-[linear-gradient(180deg,oklch(0.235_0.18_268)_0%,oklch(0.18_0.14_268)_100%)] shadow-[0_30px_70px_-28px_oklch(0.235_0.18_268/0.5)]">
        <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
          <span className="font-mono text-[10px] uppercase tracking-[0.22em] text-white/50"></span>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground antialiased">
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, oklch(0.235 0.18 268) 0%, oklch(0.18 0.14 268) 100%)",
        }}
      >
        <div
      ...
      <section id="capabilities" className="bg-grad-capabilities border-b border-border/70 py-12">
        <Shell>
      ...
      <section id="architecture" className="bg-grad-architecture border-b border-border/70 py-12">
        <Shell>
